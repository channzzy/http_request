...
class DeletePage extends StatelessWidget {
  static const routeName = '/delete-provider';
  @override
  Widget build(BuildContext context) {
    final deleteProvider = Provider.of<DeleteProvider>(context, listen: false);
    return Scaffold(
      appBar: AppBar(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          deleteProvider.deleteData(context);
        },
